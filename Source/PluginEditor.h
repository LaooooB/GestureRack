...
public:
    ...
    void mouseMove (const juce::MouseEvent& e) override
    {
        ...
        if (p != lastMousePos) { lastMousePos = p; repaint(); }
    }
...
private:
    ...
    {
    public:
        std::function<void (const juce::MouseEvent&)> dragDown, dragMove, dragUp, hoverMove;
        std::function<void()> hoverExit;
        void mouseDown (const juce::MouseEvent& e) override { juce::TextButton::mouseDown (e); if (dragDown) dragDown (e); }
        void mouseDrag (const juce::MouseEvent& e) override { juce::TextButton::mouseDrag (e); if (dragMove) dragMove (e); }
        void mouseUp (const juce::MouseEvent& e) override { if (dragUp) dragUp (e); juce::TextButton::mouseUp (e); }
        void mouseMove (const juce::MouseEvent& e) override { juce::TextButton::mouseMove (e); if (hoverMove) hoverMove (e); }
        void mouseExit (const juce::MouseEvent& e) override { juce::TextButton::mouseExit (e); if (hoverExit) hoverExit(); }
    };
